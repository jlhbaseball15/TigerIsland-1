...
public class GameRulesTest {
    ...
    public void PlacingATileThatIsNotFlat() throws GameRulesException {
       ...
       try {
           ...
           char expectedMessage[] = "The game.Tile Is Not Sitting On Three Hexes".toCharArray();
           char actualMessage[] = e.getMessage().toCharArray();
           Assert.assertArrayEquals(expectedMessage, actualMessage);
       };
    ...
    public void PlacingATileOnTopOfAnother() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "The game.Tile Is Directly Over Another game.Tile".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void PlacingTileOnUnevenLevels() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "The game.Tile Is Located Over Different Leveled Tiles".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    ...
    public void BoardNotEmptyAndPlacingTileByItself() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "The game.Tile Is Not Adjacent To An Existing game.Tile".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void PlacingTileOnEvenLevelsAndVolcanosDontOverLap() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "The game.Tile's Volcano Is Not Aligned With A Volcano game.Hex".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void CannotPlaceOnTotoroOrTiger() throws GameRulesException{
        ...
        try {
            ...
            char expectedMessage[] = "game.Tile's Cannot Be Placed On A Totoro or A Tiger".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void NewSettlementOnNonExistantHex () {
        ...
        try {
            ...
            char expectedMessage[] = "Cannot Build On An Empty game.Hex".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void NewSettlementOnOccupiedHex() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "Cannot Build On An Occupied game.Hex".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void NewSettlementWithNoVillagers() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "game.Player Does Not Have Enough Villagers".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void NewSettlementAboveLevelOne() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "Cannot Build New game.Settlement Above Level One".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void placingTotoroAwayFromSettlement() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "Must build Totoro next to the game.Settlement".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
    ...
    public void placeTigerAwayFromTheSettlement() throws GameRulesException {
        ...
        try {
            ...
            char expectedMessage[] = "Must build Tiger next to the game.Settlement".toCharArray();
            char actualMessage[] = e.getMessage().toCharArray();
            Assert.assertArrayEquals(expectedMessage, actualMessage);
        };
    }
