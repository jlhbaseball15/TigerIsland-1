...
public class CucumberPieces {
    ...
    public void placingameepleinanoccupiedhex(){
        ...
        try {
            ...
            char [] expected = "Cannot Build On An Occupied game.Hex".toCharArray();
            char [] actual = e.getMessage().toCharArray();
    ...
    public void meepleonemptyspottest(){
        ...
        try {
            ...
            char [] expected = "Cannot Build On An Empty game.Hex".toCharArray();
            char [] actual = e.getMessage().toCharArray();
    ...
    public void tryingtobuildanewsettlementabovelevelonetest(){
        ...
        try {
            ...
            char [] expected = "Cannot Build New game.Settlement Above Level One".toCharArray();
            char [] actual = e.getMessage().toCharArray();
    ...
    public void cantplacemeepleifallplayed(){
        ...
        try {
            ...
            char [] expected = "game.Player Does Not Have Enough Villagers".toCharArray();
            char [] actual = e.getMessage().toCharArray();
